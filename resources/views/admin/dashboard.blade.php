...
@section('konten')
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    <img
                        src="{{ asset('assets/adminlte/img/AdminLTELogo.png') }}"
                                ...
                                <small class="contacts-list-date float-end"> 2/28/2023 </small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="{{ asset('assets/adminlte/img/user7-128x128.jpg') }}"
                                ...
                                <small class="contacts-list-date float-end"> 2/20/2023 </small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="{{ asset('assets/adminlte/img/user5-128x128.jpg') }}"
                                ...
                                <small class="contacts-list-date float-end"> 2/10/2023 </small>
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img
                                                        class="contacts-list-img"
                                                        src="{{ asset('assets/adminlte/img/user6-128x128.jpg') }}"
    ...
    <script src="{{asset('assets/adminlte/css/adminlte.css')}}"></script>
    <!--end::Required Plugin(AdminLTE)-->
