...
<header class="bg-gray-dark sticky top-0 z-50">
    <div class="container mx-auto flex justify-between items-center py-4">
        ...
        <a href="index.html" class="flex items-center">
            <div>
                <img src="{{ asset('assets/tailstore/images/template-white-logo.png') }}"
 alt="Logo" class="h-14 w-auto mr-4">
        ...
        <div class="hidden lg:flex items-center space-x-4 relative">
            ...
            <div class="relative group cart-wrapper">
                <a href="/cart.html" >
                    <img src="{{ asset('assets/tailstore/images/cart-shopping.svg') }}"
 alt="Cart" class="h-6 w-6 group-hover:scale-120">
                </a>
                <!-- Cart dropdown -->
            ...
            <a id="search-icon" href="javascript:void(0);" class="text-white hover:text-secondary group">
                <img src="{{ asset('assets/tailstore/images/search-icon.svg') }}"
 alt="Search"
